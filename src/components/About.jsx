...
const About = () => {
  return (
    <>
      ...
      >
        Je suis un développeur logiciel expérimenté, spécialisé en TypeScript et JavaScript, avec une expertise dans des frameworks tels que React, Node.js et Three.js. Je suis un apprenant rapide et collabore étroitement avec les clients pour créer des solutions efficaces, évolutives et conviviales qui résolvent des problèmes concrets. Travaillons ensemble pour concrétiser vos idées !
      </motion.p>
